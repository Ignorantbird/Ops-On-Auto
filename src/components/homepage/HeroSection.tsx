  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
        ...
        <p className="font-body text-lg sm:text-xl md:text-2xl text-white/90 max-w-2xl mx-auto mb-10 leading-relaxed">
          Growing businesses in real estate, manufacturing, and automotive are
          leaving money on the table with slow follow-ups, missed leads, and
          operations running on WhatsApp and Excel. We fix that with custom
          automation built specifically for how your business works.
        </p>
