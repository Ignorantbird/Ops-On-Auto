  ...
  return (
    <section className="pt-28 pb-20 bg-gradient-to-b from-green-50 via-white to-slate-50">
      <div className="container mx-auto px-6">
        ...
        {/* Final CTA */}
        <div className="mt-10">
          <section className="py-20 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-12 text-white">
            <div className="container mx-auto px-6">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                  Ready to Deploy Your Reporting Automation?
                </h2>
                <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                  Join 200+ businesses using smart reporting automation to generate insights, automate dashboards, and streamline reporting processes.
                </p>
