...
export default function CaseStudiesCTANew() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="font-body text-lg text-white/70 max-w-2xl mx-auto">
            Every business we work with starts with a free audit. We&apos;ll map
            your current workflows, identify the biggest time-sinks, and show you
            exactly what automation can do — no commitment required.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-12">
          ...
          {/* Divider — matching homepage FinalCTANew exactly */}
        ...
        <p className="text-center text-white/40 font-body text-sm mt-10">
          Trusted by SMBs across manufacturing, real estate, and lead generation in India
        </p>
      </div>
    </section>
  );
