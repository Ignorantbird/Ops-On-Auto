...
export default function AboutCTANew() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="font-body text-lg text-white/70 max-w-2xl mx-auto">
            No sales reps. No account managers. When you book an audit, you speak directly
            with Yash and Sarmistha — the people who will actually build your system.
          </p>
        </div>
