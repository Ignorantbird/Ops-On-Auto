// src/pages/GenerativeAI.tsx - UPDATED TO MATCH BUSINESS AUTOMATION STRUCTURE
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO 
        ...
        description="Professional Generative AI services. Custom AI that creates brand-consistent content, proposals, and marketing materials at scale. AI Data Processing and Programmatic SEO solutions starting from $800."
        keywords="generative AI, AI content creation, automated content, brand voice AI, marketing automation, AI copywriting, content scaling, creative automation, AI data processing, programmatic SEO"
