  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO 
        ...
        description="Professional workflow automation services. Eliminate bottlenecks and repetitive tasks with intelligent automation that adapts to your business processes. Starting at ₹30,000."
