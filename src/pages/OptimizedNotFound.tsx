// src/pages/OptimizedNotFound.tsx - CRO OPTIMIZED 404 PAGE WITH STRONG CTA
import Navigation from "@/components/Navigation";
import Footer from "@/components/Footer";
import { Button } from "@/components/ui/button";
import { Home, ArrowLeft, MessageCircle, Calendar, Search, Lightbulb, Bot, Zap } from "lucide-react";
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mt-12">
              <Link to="/" className="inline-flex items-center gap-2 text-slate-600 hover:text-orange-600 font-medium transition-colors duration-200">
